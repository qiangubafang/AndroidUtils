...
interface ILogcatViewerService {
	...
	/**
         ...
         * @param buffer it can be 'main', 'radio', 'events' Check {@link org.tcshare.logcatviewer.utils.Constants} class.
         */
        void changeLogcatSource(String buffer);

        /**
         * Restart {@link org.tcshare.logcatviewer.service.LogcatViewerService} service.
         */
        void restart();

        /**
         * Stop {@link org.tcshare.logcatviewer.service.LogcatViewerService} service.
         */
        void stop();
         ...
         * Logs are saved to file after every {@link org.tcshare.logcatviewer.service.LogcatViewerService#LOG_SAVING_INTERVAL}.
