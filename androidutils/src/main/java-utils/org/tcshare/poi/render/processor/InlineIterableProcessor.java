...
import org.tcshare.poi.xwpf.ParentContext;
import org.tcshare.poi.xwpf.RunBodyContext;
import org.tcshare.poi.xwpf.RunBodyContextFactory;
...
public class InlineIterableProcessor extends AbstractIterableProcessor {
    ...
    public void visit(InlineIterableTemplate iterableTemplate) {
        logger.info("Process InlineIterableTemplate:%s", iterableTemplate);
