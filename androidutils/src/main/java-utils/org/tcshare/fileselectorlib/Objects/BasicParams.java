...
import static org.tcshare.fileselectorlib.Objects.FileInfo.FileType.File;
import static org.tcshare.fileselectorlib.Objects.FileInfo.FileType.Folder;
...
public class BasicParams {
    ...
    public interface OnOptionClick{
        void onclick(TCFileSelectorActivity activity, String currentPath, List<String> FilePathList, List<String> FilePathSelected);
    }
}
