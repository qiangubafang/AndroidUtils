...
public final class ByteUtils {
    ...
    private static MyLogger logger = MyLogger.getLogger(ByteUtils.class);
    ...
    public static byte[] getUrlByteArray(String urlPath) {
        try {
            ...
            logger.error("getUrlPictureStream error,%s,%s", urlPath, e);
        }
        return null;
    }
    ...
    public static byte[] getLocalByteArray(File res) {
        try {
            logger.info("Read contents from local path:%s", res.toPath());
    ...
    public static InputStream getUrlStream(String urlPath) throws IOException {
        logger.info("Read contents from remote uri:%s", urlPath);
