...
public class WifiActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mWiFiManager.getWifiState() == WifiManager.WIFI_STATE_ENABLED) {
            ToastUtil.showToastLong(this, "WiFi可用");
        }

        listView = (ListView) findViewById(R.id.listView);
        wifiAdapter = new WifiAdapter(this, list, mWiFiManager);
    ...
    public void getWiFiInfo(View view) {
        ...
        Log.i("wifi", "mac: " + wifiInfo.getMacAddress());
        Log.i("wifi", "speed: " + wifiInfo.getLinkSpeed());
        Log.i("wifi", "ip: " + wifiInfo.getIpAddress());
        Log.i("wifi", "netwok id: " + wifiInfo.getNetworkId());
        StringBuilder msg = new StringBuilder();
        msg.append("SSID: ").append(wifiInfo.getSSID()).append("\n");
        msg.append("BSSID: ").append(wifiInfo.getBSSID()).append("\n");
        msg.append("MAC ").append(wifiInfo.getMacAddress()).append("\n");
        msg.append("SPEED: ").append(wifiInfo.getLinkSpeed()).append("\n");
        msg.append("IP: ").append(wifiInfo.getIpAddress()).append("\n");
        msg.append("NETWOK ID: ").append(wifiInfo.getNetworkId()).append("\n");
        new AlertDialog.Builder(view.getContext()).setTitle("WIFI状态")
                .setMessage(msg)
    ...
    public void connCustomNetWork(View view) {
        // 连接到一个有效网络 - 1900
        WifiConfiguration configuration = createWifiConfig("TP-LINK-HIDDEN", "", Data.WIFI_CIPHER_NOPASS);
