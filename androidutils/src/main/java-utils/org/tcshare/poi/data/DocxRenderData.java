...
import org.tcshare.poi.util.ByteUtils;
...
public class DocxRenderData implements RenderData {
     ...
     * @param renderDatas
     */
    public DocxRenderData(Context ctx, Uri docx, List<?> renderDatas) throws IOException {
        this(AndroidUriUtil.openInputStream(ctx, docx), renderDatas);
    }
