...
public class LogcatViewerFloatingView extends StandOutWindow {
    ...
    public void createAndAttachView(int id, FrameLayout frame) {
        ...
        final View rootView = inflater.inflate(R.layout.logview_main, frame, true);
...
//      emailIntent.putExtra(Intent.EXTRA_EMAIL, new String[] { "sandeep@fatangare.info" });
        emailIntent.putExtra(Intent.EXTRA_SUBJECT, "[" + getAppName() + "] Logcat Logs");
        emailIntent.setType("text/plain");
        emailIntent.putExtra(Intent.EXTRA_TEXT, "Please find attached logcat logs file.");
