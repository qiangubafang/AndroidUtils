...
import org.tcshare.poi.data.AttachmentRenderData;
import org.tcshare.poi.data.AttachmentType;
...
public class AttachmentRenderPolicy extends AbstractRenderPolicy<AttachmentRenderData> {
    ...
    public void doRender(RenderContext<AttachmentRenderData> context) throws Exception {
        ...
        double widthPt = UnitUtils.pixelToPoints(style.getWidth());
        double heightPt = UnitUtils.pixelToPoints(style.getHeight());
