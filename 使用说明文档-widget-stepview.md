...
```xml
<org.tcshare.widgets.stepview.FlowViewHorizontal
...
```java
     ...
     * @param map 标题-颜色
     */
    public void setKeyColorByName(Map<String, String> map);    
    public void setKeyColorByIndex(Map<String, String> map);
```
...
```xml
<org.tcshare.widgets.stepview.FlowViewVertical
        android:id="@+id/vflow"
        android:layout_width="match_parent"
...
``` java
     ...
     */
    public void setKeyColorByName(Map<String, String> map);    
    public void setKeyColorByIndex(Map<Integer, String> map); // 最终都会转换为index的方式
