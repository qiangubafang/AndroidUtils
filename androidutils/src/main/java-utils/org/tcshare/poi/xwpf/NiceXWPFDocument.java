...
public class NiceXWPFDocument extends XWPFDocument {
    ...
    private static MyLogger logger = MyLogger.getLogger(NiceXWPFDocument.class);
    ...
    static {
        try {
            ...
            logger.warn("init releation error: %s", e.getMessage());
        }
    }
    ...
    protected void onDocumentCreate() {
        ...
        try {
            ...
            logger.warn("Create new document error: %s", e.getMessage());
        }
    }
