...
import org.tcshare.poi.exception.ExpressionEvalException;
 ...
 */
public class Dot {
    private MyLogger logger = MyLogger.getLogger(Dot.class);
    ...
    private Object evalKey(Object obj) {
        ...
        if (null != readMethod) {
            try {
                ...
                logger.info("Introspector %s fail: %s", key, e.getMessage());
            }
        }
